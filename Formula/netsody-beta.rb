class NetsodyBeta < Formula
  ...
  on_macos do
    ...
    on_intel do
      url "https://download.netsody.io/binaries/macos-amd64/1.0.0-beta.9/netsody"
    end
  end
  ...
  on_linux do
    ...
    on_arm do
      if Hardware::CPU.is_64_bit?
        url "https://download.netsody.io/binaries/linux-arm64/1.0.0-beta.9/netsody"
      else
        url "https://download.netsody.io/binaries/linux-armv7/1.0.0-beta.9/netsody"
      end
    end
  end
